...
from opentwitter_mcp.config import make_serializable, COMPLIANCE_NOTICE
...
async def get_twitter_user(username: str, ctx: Context) -> dict:
    ...
    try:
        ...
        return make_serializable({"success": True, "data": result.get("data"), "_compliance_notice": COMPLIANCE_NOTICE})
